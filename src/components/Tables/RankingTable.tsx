    ...
    <table className="tw-w-full tw-table-fixed tablet:tw-table-auto @tablet:tw-table-auto tw-border-collapse">
      <thead className="tw-sticky tw-top-0">
        <tr className="tw-bg-th-gray tw-text-th-white">
          <th className="tw-text-center tw-py-1 tw-w-20 phone:tw-w-auto @phone:tw-w-auto">
            RANG
          </th>
          <th className="tw-text-left tw-py-1">TEAM</th>
          <th className="tw-text-center tw-py-1 tw-hidden phone:tw-table-cell @phone:tw-table-cell @tablet:tw-hidden ">
            SIEGE
          </th>
          <th className="tw-text-center tw-py-1 tw-hidden phone:tw-table-cell @phone:tw-table-cell tw-overflow-hidden tw-text-ellipsis">
            NIEDERLAGEN
          </th>
          <th className="tw-text-center tw-py-1 tw-w-24 phone:tw-w-auto @phone:tw-w-auto">
            PUNKTE
          </th>
        </tr>
      </thead>
...
const RankingTableRow = ({
  ...
  return (
    ...
    >
      ...
      <td className={`tw-text-center tw-py-2 tw-hidden phone:tw-table-cell @phone:tw-table-cell`}>
